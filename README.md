...
🔭 Future Feature
- **[Add more pages]**
- **[Add more some cities]**
- **[Add more elements of weather]**
- **[Add Multilingual support so that users can use the lang parameter to get the output in their language.]**

## 🤝 Contributing <a name="contributing"></a>

Contributions, issues, and feature requests are welcome!

Feel free to check the [issues page](https://github.com/yayaismaail/react-capstone/issues).
...
I would like to thank my learning partners, morning and standup team members, mentors and other friends who helped throughout the process. I would also like to appreciate [Nelson Sakwa on Behance](https://www.behance.net/sakwadesignstudio) who prepared the original design
